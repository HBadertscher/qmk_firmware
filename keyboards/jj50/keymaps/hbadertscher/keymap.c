...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |------+------+------+------+------+------+------+------+------+------+------+------|
     * |Raise | Alt  | Left |Right | Del  |    Space    | MOD4 | Up   | Down |  ü   | Raise|
     * `-----------------------------------------------------------------------------------'
     */
    [_DEFLT] = LAYOUT( \
     ...
     MO(_RAISE), KC_LALT, KC_LEFT, KC_RIGHT,KC_DEL,  KC_SPC,  KC_SPC,  KC_LGUI, KC_UP,   KC_DOWN, CH_UE,   MO(_RAISE)   \
    ),
    ...
    [_RAISE] = LAYOUT( \
       ...
       _______, CH_HASH, CH_TILD, CH_LPRN, CH_RPRN, CH_BSLS, CH_QUOT, CH_4,    CH_5,    CH_6,    _______, _______, \
       KC_CAPS, CH_PERC, CH_CARR, CH_LBRC, CH_RBRC, CH_PIPE, _______, CH_1,    CH_2,    CH_3,    _______, _______, \
       _______, CH_LESS, CH_MORE, _______, _______, _______, _______, CH_0,    CH_0,    CH_DOT,  _______, _______\
    )
};
